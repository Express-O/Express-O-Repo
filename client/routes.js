...
import { Login, Signup, UserHome, SingleProduct, AllProducts, HomePage, NewProduct, EditProduct, ReviewForm, Cart, EditUserForm } from './components'
      ...
      <Switch>
...

        {
          ...
          <Switch>
            ...
            <Route path="/:userId/edit" component={EditUserForm} />
          </Switch>
        }
