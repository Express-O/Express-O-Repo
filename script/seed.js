...
async function seed () {
  ...
  const users = await Promise.all([
    User.create({firstName: 'Cody', lastName: 'McGee', streetName: '145 North 5th Street', city: 'Manhattan', state: 'NY', zip: 11201, country: 'USA', email: 'cody@email.com', password: '123'}),
  ...
  const products = await Promise.all([
    ...
    Product.create({title: `Cappuccino`, description: `An espresso-based coffee drink that originated in Italy, and is traditionally prepared with double espresso, and steamed milk. Variations of the drink involve the use of cream instead of milk, and flavoring with cinnamon or chocolate powder. It is typically smaller in volume than a caffè latte, with a thicker layer of micro foam.
    ...
    Product.create({title: `Caffè Macchiato`, description: `Sometimes called espresso macchiato, is an espresso coffee drink with a small amount of milk, usually foamed. In Italian, macchiato means "stained" or "spotted" so the literal translation of caffè macchiato is "stained coffee", or coffee with a spot of milk. The origin of the name "macchiato" stems from baristas needing to show the serving waiters the difference between an espresso and an espresso with a tiny bit of milk in it; the latter was "marked". The caffè macchiato has the highest ratio of espresso to milk of any drink made with those ingredients. The intent is that the milk moderates, rather than overwhelms, the taste of the coffee while adding a touch of sweetness. The drink is typically prepared by pouring a small amount of steamed milk directly into a single shot of espresso. As much as this sounds like 'mocha' there is absolutely no chocolate in this coffee. Our Caffè Macchiatos are made from our premium beans`, price: 350, inventory: 15, photo: 'https://keithpp.files.wordpress.com/2015/07/caffe-macchiato-cappuccino-july-2015.jpg',  category: 'drink'}),
    Product.create({title: `Caffè Mocha`, description: `This a chocolate-flavored variant of a caffè latte. Other commonly used spellings are mochaccino and also mochachino. The name is derived from the city of Mocha, Yemen, which was one of the centers of early coffee trade. Like a caffè latte, caffè mocha is based on espresso and hot milk, but with added chocolate, in the form of sweet cocoa powder. Our mochas can contain dark chocolate. Our lattès are made from our premium beans and finest of chocolates`, price: 500, inventory: 15, photo: 'https://blog.cafecampesino.com/wp-content/uploads/recipe-images/Mocha-de-Mexico.jpg',  category: 'drink'}),
    Product.create({title: `Caffè Americano`, description: ` Also known simply as Americano (shortened from Italian: caffè americano or American; Spanish: café americano, literally American coffee) is a type of coffee drink prepared by diluting an espresso with hot water, giving it a similar strength to, but different flavor from traditionally brewed coffee. Please note there is no dairy, vegan or otherwise, in this version. Our Caffè Americanos are made from our premium beans`, price: 500, inventory: 15, photo: 'https://d3mrtwiv4dr09z.cloudfront.net/media/catalog/product/cache/2/image/600x/9df78eab33525d08d6e5fb8d27136e95/1/7/17BRD_BEV_16_Americano_FA_LARGE.png',  category: 'drink'}),
    Product.create({title: `Guide To Coffe Poster`, description: `Do the many styles of coffee confuse you? have no fear with this cute poster`, price: 1500, inventory: 15, photo: 'https://previews.123rf.com/images/mix3r/mix3r1410/mix3r141000039/33043341-coffee-type-recipe-illustration.jpg',  category: 'swag'}),
    Product.create({title: `Cappuccino Glass`, description: `When you brew at home you always have the best to brew, but you should also have the best to showcase your wonderful drinks. Made with the finest tempered glass have no fear of temperature fluctuations`, price: 1650, inventory: 15, photo: 'https://www.dollartree.com/assets/product_images_2016/styles/xlarge/261271.jpg',  category: 'swag'}),
    ...
    Product.create({title: `Coffee Percolator`, description: `Brew at home with our amazing quality percolator, just as much fun to brew as it is to say!`, price: 4700, inventory: 15, photo: 'https://i02.hsncdn.com/is/image/HomeShoppingNetwork/prodfull/elite-platinum-stainless-steel-12-cup-percolator-d-2013110818163475~7332717w.jpg',  category: 'swag'}),
