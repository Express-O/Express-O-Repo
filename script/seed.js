...
async function seed () {
  ...
  const products = await Promise.all([
    ...
    Product.create({productId: 2, title: `Cappuccino`, description: `An espresso-based coffee drink that originated in Italy, and is traditionally prepared with double espresso, and steamed milk. Variations of the drink involve the use of cream instead of milk, and flavoring with cinnamon or chocolate powder. It is typically smaller in volume than a caffè latte, with a thicker layer of micro foam.
